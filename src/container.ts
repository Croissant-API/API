...
import { IMarketplaceService, MarketplaceService } from "./services/MarketplaceService";
...
container.bind<IMarketplaceService>("MarketplaceService").to(MarketplaceService).inSingletonScope();
