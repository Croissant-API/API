...
export declare class Users {
    ...
    constructor(userService: IUserService, steamOAuthService: SteamOAuthService, mailService: MailService, studioService: StudioService);
    ...
    changeRole(req: AuthenticatedRequest, res: Response): Promise<Response<any, Record<string, any>>>;
